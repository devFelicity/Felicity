...
public static class KnownMementos
{
    ...
    private const string d = "@DooZthegamer";
    ...
    public static readonly Mementos KnownMementoList = new()
    {
        MementoList = new MementoList
        {
            ...
            Trials = new[]
            {
                ...
                new MementoCat
                {
                    Author = d, Name = "Beloved", Url = "https://whaskell.pw/images/mementos/trials-beloved.png",
                    Source = MementoSource.SeasonHaunted
                },
                new MementoCat
                {
                    Author = d, Name = "Beloved (Ornamented)", Url = "https://whaskell.pw/images/mementos/trials-beloved-orn.png",
                    Source = MementoSource.SeasonHaunted
                }
            },
            Nightfall = new[]
