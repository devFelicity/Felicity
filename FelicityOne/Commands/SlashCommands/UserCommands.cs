...
using static FelicityOne.Services.OAuthService;
        ...
        switch (registered)
        {
            case UserLinkStatus.NotRegistered:
                ...
                await FollowupAsync(
                    ...
                    BungieAPI.GetApiClient().OAuth.GetOAuthAuthorizationUrl(newUser.State));
                break;
            case UserLinkStatus.Incomplete:
                ...
                await FollowupAsync(
                    ...
                    BungieAPI.GetApiClient().OAuth.GetOAuthAuthorizationUrl(user.State));
                break;
