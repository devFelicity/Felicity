...
internal static class Wishes
{
    public static readonly List<Wish> KnownWishes = new()
    {
        ...
        new Wish
        {
            Name = "A wish for others to celebrate your success.", Description = "Unlocks Numbers of Power emblem",
            Number = 3
        },
        ...
        new Wish
        {
            Name = "A wish to open your mind to new ideas.", Description = "Adds an effect around the players head",
            Number = 12
        },
        new Wish
        {
            Name = "A wish for the means to feed an addiction.", Description = "Enables Petra's Run (flawless)",
            Number = 13
        },
