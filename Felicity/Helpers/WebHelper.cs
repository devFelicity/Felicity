...
namespace Felicity.Helpers
{
    internal class WebHelper
    {
        ...
        public static async Task Start()
        {
            ...
            config.SSLCertificate = new X509Certificate2("C:\\Users\\William\\OneDrive\\Documents\\SSH\\test\\certificate.pfx", "secret");
    ...
    public class AuthorizationHandler : IHttpModule
    {
        public async Task<bool> HandleAsync(IHttpContext context)
        {
            ...
            request.AddHeader("Authorization", $"Basic {Base64Encode("client-id:client-secret")}");
