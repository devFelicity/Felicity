...
- __Application__ means the software program provided by the Company downloaded by You on any electronic device, named Felicity
...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Felicity.
...
- By email: contact@whaskell.pw


- By visiting this page on our website: [https://tryfelicity.one](https://tryfelicity.one)